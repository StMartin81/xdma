...
#define XDMA_OFS_SGDMA_COMMON 0x6000
#define MAX_NUM_ENGINES (XDMA_CHANNEL_NUM_MAX * 2)
#define C2H_CHANNEL_OFFSET 0x1000
...
static inline int
xdma_device_flag_test_n_set(struct xdma_dev* xdev, unsigned int f)
{
  unsigned long flags;
  int rv = 0;
...
static inline void
xdma_device_flag_set(struct xdma_dev* xdev, unsigned int f)
{
  unsigned long flags;
...
void
xdma_device_offline(struct pci_dev* pdev, void* dev_handle);
void
xdma_device_online(struct pci_dev* pdev, void* dev_handle);
...
ssize_t
xdma_engine_read_cyclic(struct xdma_engine*, char __user*, size_t, int);
int
